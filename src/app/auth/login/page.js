      ...
      >
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full px-4 py-2 rounded-lg border border-white bg-opacity-20  placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#371d68]"
        ...
        <button
          onClick={handleLogin}
          className={`w-full bg-[#4615c9] hover:bg-[#371d68] text-white transition-all delay-75  rounded-lg focus:outline-none py-2 ${
